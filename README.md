...
| Project Link | Project Description | Domain |
| ------------ | ------------------- | ------- |
| [Service Criticality Analysis](https://github.com/rml-lee/Excel-Service-Criticality-Analysis) | This project showcases my proficiency in excel in being able to utilize LOOKUP functions, Pivot Tables, and visualizations. | Risk Management and Business Continuity Planning
